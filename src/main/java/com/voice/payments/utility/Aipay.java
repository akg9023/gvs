package com.voice.payments.utility;
...
public class Aipay {
	...
	public static ResponseEntity<PaymentTokenResponse> initTransactionForAipay(String merchId, String amount, String merchTxnId, String returnURL,
																			  ...
																			  String udf2, String udf3, String udf4, String udf5,String paymentUrl) {
		...
		try {
			URL url = new URL(paymentUrl + "merchId=" + merchId + "&encData=" + encData);
		...
		try {
			...
			try {
				...
				paymentTokenResponse.setAtomTokenId(atomTokenId);
				paymentTokenResponse.setMerchId(merchId);
				paymentTokenResponse.setCustEmail(custEmail);
				paymentTokenResponse.setCustMobile(custMobile);
				paymentTokenResponse.setReturnUrl(returnURL);
				return ResponseEntity.ok(paymentTokenResponse);
